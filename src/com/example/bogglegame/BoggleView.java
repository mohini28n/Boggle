...
public class BoggleView extends View {
	...
	public void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		dicePadding = diceWidth
				/ (Math.max(Boggle.DICE_WIDTH, Boggle.DICE_HEIGHT) + 1);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		int x = (int) ((event.getX() - (dicePadding / 2f)) / (diceWidth + dicePadding));
		int y = (int) ((event.getY() - (dicePadding / 2f)) / (diceHeight + dicePadding));
